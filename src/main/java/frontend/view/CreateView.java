...
import frontend.controller.CreateController;
...
public class CreateView {
    ...
    public void update(FoodRequest food, Macro totals){
        nameLabel.setText(food.name()+" ("+
                food.producer()+")");

        if(food.servingSize()==(int)(food.servingSize().intValue()))
            quantity.setText("  "+(int)(food.servingSize().intValue())+"  ");
        else
            quantity.setText(String.format("%.1f", food.servingSize()));


        measureLabel.setText("  "+food.servingUnits()+"  ");

        calories.setText((int)(food.kcal())+"");
        protein.setText((int)(food.protein().intValue())+"g");
        fat.setText((int)(food.fat().intValue())+"g");
        carbs.setText((int)(food.carbs().intValue())+"g");

        caloriesProgress.setValue((int) ((food.kcal())*100/
                totals.getKcal()));
        caloriesPercentage.setText(caloriesProgress.getValue()+"%");
        caloriesTotal.setText(totals.getKcal()+"");

        proteinProgress.setValue((int) ((food.protein())*100/
                totals.getProtein()));
        proteinPercentage.setText(proteinProgress.getValue()+"%");
        proteinTotal.setText(totals.getProtein()+"");

        fatProgress.setValue((int) ((food.fat())*100/
                totals.getFat()));
        fatPercentage.setText(fatProgress.getValue()+"%");
        fatTotal.setText(totals.getFat()+"");

        carbsProgress.setValue((int) ((food.carbs())*100/
                totals.getCarbs()));
